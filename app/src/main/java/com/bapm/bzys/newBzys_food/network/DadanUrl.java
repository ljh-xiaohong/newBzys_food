...
//	public static final int STORE_DETAIL_URL_CODE=228;
    ...
    public static final int COMMIT_PEOPLE_NUMBER_CODE    = 239;
    public static final int CHANGE_ORDER_NUMBER_CODE    = 240;
    public static final int GET_TABLE_NUMBER_CODE    = 241;
    public static final int CHANGE_TABLE_NUMBER_CODE    = 242;
    public static final int GET_REGISTRATION_CODE    = 243;
    public static final int BINDCODE_CODE    = 244;
...
//    = BASE_ONE_URL+"BaseApi/GetGalleryInfo/";
  ...
  //商品删除
    ...
    public static final String ORDER_RECEIPT_URL
            = BASE_ONE_URL+"CompanyOrder/PostOrderStatus/";
    //修改商品销售状态
    public static final String COMMODITY_STATUS_CHANGE_URL
            = BASE_ONE_URL+"CompanyOrder/PostUpdateGoodsSaleStatus/";
    //修改用餐人数
    public static final String COMMIT_PEOPLE_NUMBER_URL
            = BASE_ONE_URL+"CompanyOrder/PostChangeNumber/";
    //修改订单详情数量
    public static final String CHANGE_ORDER_NUMBER_URL
            = BASE_ONE_URL+"CompanyOrder/PostUpdateOrderNumber/";
    //获取可换的桌台
    public static final String GET_TABLE_NUMBER_URL
            = BASE_ONE_URL+"CompanyOrder/GetPromotionByCompanyId/";
    //更换桌台
    public static final String CHANGE_TABLE_NUMBER_URL
            = BASE_ONE_URL+"CompanyOrder/PostChangeTable/";
    //获取用户极光推送注册ID
    public static final String GET_REGISTRATION_URL
            = BASE_ONE_URL+"CompanyInfo/PostCompanyRegistrationId/";
    //绑定桌台码
    public static final String BINDCODE_URL
            = BASE_ONE_URL+"Promotion/PostAddPromotionQRCode/";
    //获取菜品销售概况
    public static final String GET_FOOD_SALE_LIST_URL
            = BASE_ONE_URL+"Report/GetReportByGoodsType/";
    //获取统计报表-统计桌台订单，浏览量，总销售额
    public static final String GET_TABLE_SALE_LIST_URL
            = BASE_ONE_URL+"Report/GetReportByTableSales/";
}
