package com.bapm.bzys.newBzys_food.buletooth.manager;
...
public class BltManager {
     ...
     */
    public void getBltList(Handler handler) {
...
//                mBluetoothSocket = (BluetoothSocket)m.invoke(btDev, Integer.valueOf(2));
//            }
            ...
            if (mBluetoothSocket != null)
                ...
                UseDeviceSizeApplication.bluetoothSocket = mBluetoothSocket;
    ...
    public void clickBlt(Context context, int status) {
        switch (status) {
            case BltContant.BLUE_TOOTH_SEARTH://搜索蓝牙设备，在BroadcastReceiver显示结果
                ...
                break;
            case BltContant.BLUE_TOOTH_SEARTH_CENCLE://搜索蓝牙设备，在BroadcastReceiver显示结果
                stopSearthBltDevice();
                break;
